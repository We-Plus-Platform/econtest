...
$pic_result=$hand->query("SELECT pic FROM account_user WHERE user='$_SESSION[user]'");
if($pic_result->num_rows){
    $pic = 'media/UserPortrait/' . $pic_result->fetch_assoc()['pic'];
}else{
    $pic = 'images/head.png';
}
?>
...
<body>
    ...
    <div id="modal1">
        <div class="mbox">
            <div style="height: 10%"><span onclick="modalClose()" style="height:40px;float: right;font-size: 40px;cursor: pointer ">×</span>
            </div>
...
" onclick="ajaxPost('newteam.php')">提交
    ...
    <div id="sai_header">
        <div class="topUserSection">
            <div class="ren_img">
                <img class="img-fluid" src="<?php echo $pic?>">
            </div>
...
">
                    <div class="topUserInfoBtn">
                        <img src="images/ID.png" style="position: absolute;padding-right: 10px;height: 40px;vertical-align: middle;">
                        <span id="userId" style="margin: auto;vertical-align: middle;font-size: 27px;"><?php echo $_SESSION['user'] ?></span>
                    </div>
                </div>
            </div>
            <div class="jie_right">
                <div class="topUserBar"><img src="images/center.png" onclick="
            <?php if (!isset($_SESSION['user'])) echo "window.location.href='login.php'";
            else  echo "window.location.href='user_center.php'"; ?>"><span>个人中心</span></div>
...
">
                ...
                <div class="sai_right" id="section2" hidden>
                    <h3>热门赛事</h3>
        ...
        <div class="container fouth" id="section4" hidden>
            <div class="fouthOne">
                <h3>问答</h3>
                <div class="answerOut">
                    <div>
                        <div class="answer1">
                            <div>
                                <p><span class="answerLeft">最后一个板块啦啦啦啦啦</span><span class="answerRight">问答【<span>0</span>】</span>
                                </p>
                            </div>
                            <div>
                                <p><span class="answerLeft">最后一个板块啦啦啦啦啦</span><span class="answerRight">问答【<span>0</span>】</span>
                            ...
                            <div>
                                <p><span class="answerLeft">最后一个板块啊啊啊啊啊</span><span class="answerRight">问答【<span>0</span>】</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="answer3" style="display: none;">
                            <div>
                                <p><span class="answerLeft">这是第三页啊</span><span class="answerRight">问答【<span>0</span>】</span></p>
                            </div>
                            <div>
                                <p><span class="answerLeft">最后一个板块啊啊啊啊啊</span><span class="answerRight">问答【<span>0</span>】</span>
                                </p>
                        ...
                        <div class="answer4" style="display: none;">
                            <div>
                                <p><span class="answerLeft">这是第四页</span><span class="answerRight">问答【<span>0</span>】</span>
                                </p>
                            </div>
                            <div>
                                <p><span class="answerLeft">最后一个板块啊啊啊啊啊</span><span class="answerRight">问答【<span>0</span>】</span>
                        ...
                        <div class="answer5" style="display: none;">
                            <div>
                                <p><span class="answerLeft">这是第五页</span><span class="answerRight">问答【<span>0</span>】</span>
                                </p>
                            </div>
                            <div>
                                <p><span class="answerLeft">最后一个板块啊啊啊啊啊</span><span class="answerRight">问答【<span>0</span>】</span>
                    ...
                    <div class="answerTurn">
                        <div class="pager"><input type="button" value="1"><input type="button" value="2"><input type="button" value="3"><input type="button" value="4"><input type="button" value="5"></div>


                    </div>
                </div>
            </div>
            <div class="fouthTwo" hidden>
                <h3>我的问题</h3>
                <div class="myQuestionOut">
                    <div class="myQuestion1">
                        <div>
                            <p><span class="myQuestionLeft" id="question1">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                    ...
                    <div class="myQuestion2" style="display: none;">
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢2</span><span class="myQuestionRight">问答【<span>0</span>】</span></p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
                    ...
                    <div class="myQuestion3" style="display: none;">
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢3</span><span class="myQuestionRight">问答【<span>0</span>】</span></p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
                    ...
                    <div class="myQuestion4" style="display: none;">
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢4</span><span class="myQuestionRight">问答【<span>0</span>】</span></p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
                    ...
                    <div class="myQuestion5" style="display: none;">
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢5</span><span class="myQuestionRight">问答【<span>0</span>】</span></p>
                        </div>
                        <div>
                            <p><span class="myQuestionLeft">我们要提什么问题呢</span><span class="myQuestionRight">问答【<span>0</span>】</span>
                            </p>
